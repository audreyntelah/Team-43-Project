    ...
    function scrollFunction() {
	  if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
        ...
        document.getElementById("logo_button").style.width ="5%";
        document.getElementById("logo_button").style.height ="5%";
        ...
        document.getElementById("logo_button").style.width ="300px";
        document.getElementById("logo_button").style.height ="300px";
	  }
	}
